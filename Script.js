function sendMoney() {
    ...
    if (enterAmount > enterSAmount) {
       ...
       $${enterAmount} is sent to ${enterName}@mail.com.`)

        //History of Transaction//
        var createPTag = document.createElement("li");
        var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with Email-id ${enterSName}@mail.com
        to recepient with Email-id ${enterName}@mail.com on ${Date()}.`);
